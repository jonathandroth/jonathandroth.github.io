...
**Logs with zeros? Some problems and solutions** [Previously titled "Log-like? Identified ATEs defined with zero-valued outcomes are (arbitrarily) scale-dependent"] (with Jiafeng Chen). 2023. *Revision requested, Quarterly Journal of Economics* <br/>
